...
const LoginForm = () => {
  ...
  return (
    <div className=' mt-12 w-full h-screen flex items-center justify-center'>
      <form className='p-10 border rounded-lg w-96' onSubmit={handleLogin}>
        <h1 className='text-3xl text-sky-600 font-bold mb-4'>Login</h1>
        ...
        <div className='flex flex-col'>
          ...
          <button
            type='submit'
            className='mt-10 bg-sky-600 text-slate-50 p-3 rounded'
          >
            Entrar
          </button>
        </div>
